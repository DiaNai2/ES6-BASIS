...
//actualizr: findIndex
const elementIndex = materias.findIndex((obj => obj.id === 3));
console.log("Antes: ", materias[elementIndex]);
materias[elementIndex].nombre = "Dianaaa";
console.log("Ahora: ", materias[elementIndex]);